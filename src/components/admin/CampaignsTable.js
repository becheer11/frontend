...
const CampaignsTable = () => {
  ...
  const handleApprove = async (id) => {
    try {
      ...
      await axios.put(`/api/campaign/${id}`, { adminStatus: "approved" }, config);
  ...
  const handleReject = async (id) => {
    try {
      ...
      await axios.put(`/api/campaign/${id}`, { adminStatus: "rejected" }, config);
        ...
        <tbody>
          {currentItems.map((campaign) => (
            <tr key={campaign._id}>
              ...
              <td>
                <span className={`payment-badge ${campaign.validationStatus.adminStatus}`}>
                  {campaign.validationStatus.adminStatus}
                </span>
              </td>
              ...
              <td className="actions-cell">
                ...
                {campaign.validationStatus.adminStatus === "pending" && (
                  <>
                    <button
                ...
                {campaign.validationStatus.adminStatus === "approved" && (
                  <>
                    <button
                      className="action-btn reject-btn"
                      onClick={() => handleReject(campaign._id)}
                ...
                {campaign.validationStatus.adminStatus === "rejected" && (
                  <>
                    <button
                      className="action-btn validate-btn"
                      onClick={() => handleApprove(campaign._id)}
